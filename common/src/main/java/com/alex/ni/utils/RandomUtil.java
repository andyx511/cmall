...
public class RandomUtil {
	...
	public static final String LETTERCHAR_SMALL = "0123456789abcdefghijklmnopqrstuvwxyz";
	 ...
	 * @return 随机字符串
	 */
	public static String generateStrSmall(int length) {
		StringBuffer sb = new StringBuffer();
		Random random = new Random();
		for (int i = 0; i < length; i++) {
			sb.append(LETTERCHAR_SMALL.charAt(random.nextInt(LETTERCHAR_SMALL.length())));
		}
		return sb.toString();
	}
